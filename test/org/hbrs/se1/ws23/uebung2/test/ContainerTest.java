...
public class ContainerTest {
    ...
    void testeDelete() throws ContainerException {
        container.addMember(member1);
        container.addMember(member2);
        assertEquals("Member erfolgreich entfernt.",container.deleteMember(1));
        assertEquals("Member erfolgreich entfernt.",container.deleteMember(2));
    }
    @Test
    ...
    void negativeTests() throws ContainerException {
        ...
        assertEquals("Fehler! Kein Member mit der ID 1 gefunden.", container.deleteMember(1));
        assertEquals("Fehler! Kein Member mit der ID 2 gefunden.", container.deleteMember(2));
    }
}
